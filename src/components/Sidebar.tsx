export default function Sidebar() {
	return (
		<div className="rounded-md border bg-white p-3">
			...
			<div className="mt-2 h-28 rounded-md bg-violet-50 flex items-center justify-center text-[11px] text-violet-600">Rate Card</div>
			...
			<div className="mt-2 flex items-center gap-3 text-gray-500">
				<svg aria-label="Facebook" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-5 w-5 fill-current">
				...
				<svg aria-label="Instagram" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-5 w-5 fill-current">
				...
				<svg aria-label="X" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-5 w-5 fill-current">
