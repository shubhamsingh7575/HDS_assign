		...
		<div className="w-full border-b bg-white">
			<div className="mx-auto max-w-6xl px-4 py-3 grid grid-cols-3 items-center">
				<div className="flex items-center gap-2">
					<div className="text-2xl font-semibold bg-gradient-to-r from-[#972c96] to-[#972c96] bg-clip-text text-transparent">TailorAlly</div>
				</div>
				<div className="text-center text-sm text-gray-700">
					Welcome to <span className="font-semibold text-[#972c96]">Store Name</span> store
				</div>
