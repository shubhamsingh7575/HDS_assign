...
const cards: Card[] = [
	{title:'WINTER COLLECTION',img:'https://images.pexels.com/photos/15796731/pexels-photo-15796731.jpeg?auto=compress&cs=tinysrgb&w=1200'},
	...
	return (
		<div>
			...
			<div className="mt-3 flex justify-start">
				<button className="flex items-center gap-2 rounded-md border border-[#972c96] px-3 py-1.5 text-sm text-[#972c96] hover:bg-[#7A61FF]/10 transition-colors">
					See all
